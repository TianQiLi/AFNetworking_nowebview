Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/TianQiLi/AFNetworking_nowebview'
  s.social_media_url = 'https://twitter.com/AFNetworking'
  s.authors  = { 'Mattt Thompson' => 'm@mattt.me' }
  s.source   = { :git => 'https://github.com/TianQiLi/AFNetworking_nowebview.git', :tag => s.version, :submodules => true }
  s.requires_arc = true
